...
export const ALL_BLOG_ARTICLES: BlogArticle[] = rawSeoData
    ...
    .sort((a, b) => new Date(b.datePublished).getTime() - new Date(a.datePublished).getTime()); // Sort by most recent

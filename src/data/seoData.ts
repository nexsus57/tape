...
const rawSeoData: Omit<SeoPageData, 'summary' | 'faqs'>[] = [
  ...
  {
    "Page Type": "Industries List",
    "Page Name": "Industries List",
    "Full URL": "https://tapeindia.shop/industries",
    "Title (≤60 chars)": "Industrial Tape Solutions by Industry | Tape India",
    "Meta Description (≤160 chars)": "Tape India delivers specialized adhesive tape solutions for demanding industries like packaging, HVAC, electronics, print, and more. Find products engineered for your application.",
    "H1": "Tapes Engineered for Your Industry",
    "H2_1": "Packaging Industry Solutions",
    "H2_2": "HVAC Tapes and Adhesives",
    "H2_3": "Electronics & High-Tech Tapes",
    "H2_4": "Print, Labels & Signage Tapes",
    "H2_5": "Reflective & Safety Solutions",
    "H3": "PTFE & Teflon High-Performance Tapes",
    "H4": "Custom Solutions for Your Sector",
    "H5": "Speak to an Industry Expert",
    "Primary Keywords": "industrial tape applications, tapes by industry, manufacturing tape solutions",
    "Secondary Keywords": "packaging tape, hvac tape, electronics tape, safety tape, b2b tape supplier",
    "FAQ Schema (JSON-LD)": "{\"@context\":\"https://schema.org\",\"@type\":\"FAQPage\",\"mainEntity\":[{\"@type\":\"Question\",\"name\":\"What industries does Tape India serve?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"We provide specialized adhesive solutions for a wide range of sectors, including Packaging, HVAC, Electronics, Print & Signage, Reflective & Safety, and applications requiring PTFE & Teflon tapes.\"}},{\"@type\":\"Question\",\"name\":\"Can you recommend a tape for my specific industry application?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"Yes. Our team of experts can help you select the ideal tape based on your industry, substrates, environmental conditions, and performance requirements. Contact us for a consultation.\"}}]}",
    "Product Schema (JSON-LD)": null,
    "LocalBusiness Schema (JSON-LD)": "{\"@context\":\"https://schema.org\",\"@type\":\"IndustrialBusiness\",\"name\":\"Tape India (Sha Kundanmal Misrimal)\",\"url\":\"https://tapeindia.shop\"}",
    "Combined Schema (JSON-LD)": "{\"@context\":\"https://schema.org\",\"@graph\":[{\"@type\":\"CollectionPage\",\"name\":\"Industrial Tape Solutions by Industry | Tape India\",\"url\":\"https://tapeindia.shop/industries\"},{\"@type\":\"IndustrialBusiness\",\"name\":\"Tape India (Sha Kundanmal Misrimal)\",\"url\":\"https://tapeindia.shop\"},{\"@type\":\"FAQPage\",\"mainEntity\":[{\"@type\":\"Question\",\"name\":\"What industries does Tape India serve?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"We provide specialized adhesive solutions for a wide range of sectors, including Packaging, HVAC, Electronics, Print & Signage, Reflective & Safety, and applications requiring PTFE & Teflon tapes.\"}}]}]}",
    "CTA": "Find Your Industry Solution",
    "Schema Type": "CollectionPage + FAQ"
  },
  {
    "Page Type": "All Products List",
    "Page Name": "All Products List",
    "Full URL": "https://tapeindia.shop/products",
    "Title (≤60 chars)": "All Industrial Tapes | Manufacturer & Wholesaler | Tape India",
    "Meta Description (≤160 chars)": "Browse our complete range of over 200 industrial adhesive tapes. As a leading manufacturer in India, we offer solutions for every industry. Bulk orders welcome.",
    "H1": "All Industrial Tapes",
    "H2_1": "Filter by Category",
    "H2_2": "Filter by Industry",
    "H3": "Find Your Adhesive Solution",
    "H4": "Can't Find What You're Looking For?",
    "H5": "Request a Custom Quote",
    "Primary Keywords": "all industrial tapes, tape products list, adhesive tape catalog",
    "Secondary Keywords": "tape manufacturer india, b2b tape supplier, wholesale tape, industrial tape types",
    "FAQ Schema (JSON-LD)": "{\"@context\":\"https://schema.org\",\"@type\":\"FAQPage\",\"mainEntity\":[{\"@type\":\"Question\",\"name\":\"What types of industrial tapes do you manufacture?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"We manufacture and supply over 200 types of industrial tapes, including Safety Tapes, Reflective Tapes, Double-Sided Tapes, Specialty Tapes, PTFE/Teflon Tapes, and Antistatic/ESD Tapes.\"}},{\"@type\":\"Question\",\"name\":\"How can I find the right tape for my application?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"You can use the filters on our products page to sort by category or industry. For expert assistance, contact our technical team with your application details, and we will recommend the best solution.\"}}]}",
    "Product Schema (JSON-LD)": null,
    "LocalBusiness Schema (JSON-LD)": "{\"@context\":\"https://schema.org\",\"@type\":\"IndustrialBusiness\",\"name\":\"Tape India (Sha Kundanmal Misrimal)\",\"url\":\"https://tapeindia.shop\"}",
    "Combined Schema (JSON-LD)": "{\"@context\":\"https://schema.org\",\"@graph\":[{\"@type\":\"CollectionPage\",\"name\":\"All Industrial Tapes | Manufacturer & Wholesaler | Tape India\",\"url\":\"https://tapeindia.shop/products\"},{\"@type\":\"IndustrialBusiness\",\"name\":\"Tape India (Sha Kundanmal Misrimal)\",\"url\":\"https://tapeindia.shop\"},{\"@type\":\"FAQPage\",\"mainEntity\":[{\"@type\":\"Question\",\"name\":\"What types of industrial tapes do you manufacture?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"We manufacture and supply over 200 types of industrial tapes, including Safety Tapes, Reflective Tapes, Double-Sided Tapes, Specialty Tapes, PTFE/Teflon Tapes, and Antistatic/ESD Tapes.\"}}]}]}",
  ...
  },
  {
    ...
    "Meta Description (≤160 chars)": "Explore expert articles on industrial tapes and materials from Tape India. Learn about EMI shielding, thermal management, contamination control, and safety solutions.",
    "H1": "Industrial Insights",
    "H2_1": "Featured Articles",
    "H2_2": "Latest Posts",
    "H3": "Explore by Topic",
    "H4": "Subscribe for Updates",
    "H5": "From the Tape India Experts",
    "Primary Keywords": "industrial tape blog, adhesive technology articles, tape application guides",
    "Secondary Keywords": "tape manufacturing insights, material science blog, b2b industrial content",
    "FAQ Schema (JSON-LD)": "{\"@context\":\"https://schema.org\",\"@type\":\"FAQPage\",\"mainEntity\":[{\"@type\":\"Question\",\"name\":\"What topics does the Tape India blog cover?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"Our blog features expert articles on adhesive technology, material science, industrial tape applications, buyer's guides, and best practices for industries like electronics, HVAC, and packaging.\"}},{\"@type\":\"Question\",\"name\":\"Who writes the articles on the Industrial Insights blog?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"Our content is written by in-house experts with decades of experience in the industrial tape and adhesive manufacturing industry, ensuring you receive practical and accurate information.\"}}]}",
    "Product Schema (JSON-LD)": null,
    "LocalBusiness Schema (JSON-LD)": "{\"@context\":\"https://schema.org\",\"@type\":\"IndustrialBusiness\",\"name\":\"Tape India (Sha Kundanmal Misrimal)\",\"url\":\"https://tapeindia.shop\"}",

...
export const BlogProvider: FC<BlogProviderProps> = ({ children }) => {
  // Version 11 simply loads initial articles as default to avoid any tricky empty arrays
  const [storedArticles, setArticles] = useLocalStorage<BlogArticle[]>('tapeindia_blog_v11', INITIAL_ARTICLES);

  const articles = useMemo(() => {
    // ALWAYS ensure we have a valid array of items to prevent mapping errors

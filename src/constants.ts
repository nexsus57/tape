...
export const PRODUCTS: Omit<Product, 'seo'>[] = [
    ...
    { id: 'green-polyester-tape-with-liner', name: 'Green Polyester Tape with Liner', shortDescription: 'High-temp green polyester tape with a release liner, ideal for die-cutting applications.', category: 'specialty-tapes', features: ['Release liner for easy die-cutting', 'Same high-temp performance', 'Precise masking shapes'], uses: ['Custom die-cut masking parts', 'Electronics masking', 'Aerospace applications'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/green%20polyester%20tape%20with%20liner.webp'] },
    ...
    { id: 'conductive-grid-tape', name: 'ESD Conductive Grid Tape', shortDescription: 'A three-layer tape with a conductive grid pattern for use in Electrostatic Protected Areas (EPAs).', category: 'antistatic-esd-tapes', features: ['Creates a Faraday cage effect', 'Low static-generating', 'Transparent for visibility'], uses: ['Sealing ESD bags and containers', 'Use within EPAs', 'Securing documents in cleanrooms'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/conductive%20grid%20tape.webp'] },

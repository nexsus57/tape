...
export const PRODUCTS: Omit<Product, 'seo'>[] = [
    ...
    { id: 'green-polyester-tape-with-liner', name: 'Green Polyester Tape with Liner', shortDescription: 'High-temp green polyester tape with a release liner, ideal for die-cutting applications.', category: 'specialty-tapes', features: ['Release liner for easy die-cutting', 'Same high-temp performance', 'Precise masking shapes'], uses: ['Custom die-cut masking parts', 'Electronics masking', 'Aerospace applications'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/green%20polyster%20tape%20with%20liner.webp'] },

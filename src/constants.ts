...
export const INITIAL_INDUSTRIES_DETAILED: IndustryDetail[] = [
    {
        ...
        products: [
            'hazardtape', 'floor-marking-tape', 'coloured-anti-slip-tape', 'caution-tape', 
            'barricade-tape', 'tamper-proof-tape-1', 'nastro-heavy-duty-floor-marking', 
            'glowindark', 'anti-skid-glow-in-dark', 'esd-floor-marking', 
            'glowindark-marking', 'anti-skid', 'anti-slip-bathroom', 
            'vhb-tape', 'hot-melt-tissue-tape', 'acrylic-double-sided-tape-1', 'aacrylic-gel-tape-1', 
            'masking-tape', 'bopp-tape', 'aluminum-foil-2-tape', 'kapton-tape', 'duct-tape', 
            'high-sealing-tape', 'bag-sealing-tape', 'acetate-cloth-tape-white-19mm-x-66m-crop', 'fine-line-masking-tape', 
            'green-polyster', 'green-polyster-with-liner', 'surface-protection-tape', 
            'lamination-tape', 'filament-tape', 'ez-application-tape', 'kraft-paper-tape', 
    ...
    },
    {
        ...
        products: [
            'double-sided-scrim-tape', 'eva-foam-tape', 'spacer-tape', 'xlpe-foam-tapes', 
            'aluminum-foil-2-tape', 'duct-tape', 'pvc-pipe-tape-1', 'foil-scrim-kraft-tape', 
            'aluminium-pet', 'butyl', 'fiberglass-tape', 
            'nrm-foam-tape', 'aluminium-fr-grade', 'red-pvc-non-adhesive-tape', 
            'glass-cloth-tape', 'fr-grade-glass-cloth-tape'
        ],
        seo: {
    ...
    },
    {
        ...
        products: [
            'photoluminescent-film', '3m-foam-foam-tape', 'tissue-tape', 'polyester-double-side', 
            'vhb-tape', 'lohmann', 'pet-double-sided-tape', 'transfer-tape', 
            'acrylic-double-sided-tape-1', 'silicone-tape', 'hot-melt-tissue-tape', 'double-coated-cloth-tape-581', 
            'aacrylic-gel-tape-1', 'paper-tape', 'bag-sealing-tape', 'acetate-cloth-tape-white-19mm-x-66m-crop', 
            'surface-protection-tape', 'lamination-tape', 'ez-application-tape'
        ],
        seo: {
    ...
    },
    {
        ...
        products: [
            'esd-floor-marking', '3m-foam-foam-tape', 'polyester-double-side', 
            'pet-double-sided-tape', 'transfer-tape', 'double-sided-thermal-tape', 'double-sided-scrim-tape', 
            'eva-foam-tape', 'spacer-tape', 'xlpe-foam-tapes', 'kapton-tape', 'stickymat', 'mica-tape', 
            'green-polyster', 'green-polyster-with-liner', 'thermal-condu-pads', 
    ...
    },
    {
        ...
        products: [
            'silver-tc', 'heattransfer', 'heat-transfer-reflective-vinyl-film-tape-heat-transfer-segmented-reflective-tape',
            'pvc-reflective-tape', 'grey-reflective-yarn-2-0-mm-double-side-500x500-1', 'material-fr-reflective-tape-all-1', 
            'high-reflective-polyester', 'hipoloyster', 'oxfordrefle', 
            'grey-reflective-piping', 'ordinary-polyster-fabric', 'woven', 
...
export const PRODUCTS: Omit<Product, 'seo'>[] = [
    ...
    { id: 'coloured-anti-slip-tape', name: 'Heavy-Duty Anti-Skid & Anti-Slip Tape', shortDescription: 'Prevent slips and falls with our abrasive anti-slip tapes, perfect for stairs, ramps, and industrial floors.', category: 'safety-tapes', features: ['High-traction mineral-coated surface', 'Durable and long-lasting adhesive', 'Water and chemical resistant', 'Suitable for indoor and outdoor use'], uses: ['Stairs and steps', 'Ramps and walkways', 'Loading docks', 'Wet floor areas'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/coloured-anti-slip-tape.webp'] },
    ...
    { id: 'anti-skid-glow-in-dark', name: 'Anti-Skid Tape with Centre Glow', shortDescription: 'Combines high-traction anti-slip surface with a central photoluminescent strip for visibility in darkness.', category: 'safety-tapes', features: ['Dual-purpose safety', 'Mineral-coated anti-slip surface', 'Bright glow-in-the-dark center line'], uses: ['Emergency exit stairs', 'Dark corridors and walkways', 'Industrial platforms'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/anti%20skid%20glow%20in%20dark.webp'] },
    ...
    { id: 'anti-skid', name: 'Heavy Duty Anti-Skid Tape', shortDescription: 'Our toughest anti-slip tape with large grit particles for extreme industrial and outdoor environments.', category: 'safety-tapes', features: ['Extra-coarse abrasive surface', 'Resists oil, water, and heavy wear', 'Aggressive adhesive for rough surfaces'], uses: ['Offshore oil rigs', 'Manufacturing plants', 'Construction vehicles'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/anti%20skid.webp'] },
    { id: 'anti-slip-bathroom', name: 'Anti-Slip Tape for Bath and Shower', shortDescription: 'Provides a safe, non-abrasive, comfortable grip in wet areas like bathrooms and showers.', category: 'safety-tapes', features: ['Waterproof and mold-resistant', 'Soft-textured, non-abrasive surface', 'Clear design blends with decor'], uses: ['Bathtubs and shower floors', 'Around swimming pools', 'Locker rooms'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/anti%20slip%20bathroom.webp'] },

    // --- Reflective Tapes ---
    { id: 'silver-tc', name: 'Silver TC Sew-On Reflective Tape', shortDescription: 'High-quality silver TC tape for sewing onto safety vests and workwear to enhance visibility.', category: 'reflective-tapes', features: ['High reflectivity (EN 20471 compliant)', 'Durable TC (Terylene/Cotton) backing', 'Washable and long-lasting', 'Easy to sew'], uses: ['Safety vests', 'Work jackets and pants', 'Firefighter uniforms', 'Jogging and cycling gear'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/silver%20tc.webp'] },
    { id: 'heattransfer', name: 'Heat Transfer Reflective Film', shortDescription: 'Iron-on reflective material for safety garments, providing high visibility after application.', category: 'reflective-tapes', features: ['Applies with heat press or iron', 'Excellent reflectivity', 'Durable through washing'], uses: ['T-shirts and sportswear', 'Work uniforms', 'Caps and bags'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/heattransfer.webp'] },
    { id: 'heat-transfer-reflective-vinyl-film-tape-heat-transfer-segmented-reflective-tape', name: 'Vinyl Heat Transfer Reflective Film', shortDescription: 'Flexible, plotter-cuttable reflective vinyl for custom designs on textiles.', category: 'reflective-tapes', features: ['Stretchable and flexible', 'Easy to weed and apply', 'Bright reflective finish'], uses: ['Custom logos on sportswear', 'Athletic apparel', 'Fashion garments'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/Heat-Transfer-Reflective-Vinyl-Film-Tape-Heat-Transfer-Segmented-Reflective-Tape.webp'] },
    ...
    { id: 'grey-reflective-yarn-2-0-mm-double-side-500x500-1', name: 'Reflective Yarn & Thread', shortDescription: 'Reflective thread for weaving, knitting, or embroidering into textiles for integrated visibility.', category: 'reflective-tapes', features: ['Can be woven or sewn', 'Provides 360-degree reflectivity', 'Soft and flexible'], uses: ['Sportswear', 'Shoelaces', 'Hats and gloves'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/grey-reflective-yarn-2-0-mm-double-side-500x500%20(1).webp'] },
    ...
    { id: 'duct-tape', name: 'Heavy-Duty Cloth Duct Tape', shortDescription: 'Strong, waterproof, and versatile cloth duct tape for general repairs, bundling, and sealing.', category: 'specialty-tapes', features: ['Waterproof PE-coated cloth backing', 'Strong rubber-based adhesive', 'Hand-tearable'], uses: ['General repairs', 'Duct and pipe sealing', 'Heavy-duty bundling'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/duct%20tape.webp'] },
    { id: 'high-sealing-tape', name: 'High Temperature Sealing Tape', shortDescription: 'Specialty tapes designed for sealing applications in high-temperature environments.', category: 'specialty-tapes', features: ['Various material compositions (e.g., fiberglass, silicone)', 'Maintains seal integrity at high temps', 'Chemical resistant'], uses: ['Industrial ovens', 'Engine compartments', 'Exhaust systems'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/high%20sealing%20tape.webp'] },
    ...
    { id: 'pvc-pipe-tape-1', name: 'PVC Pipe Wrapping Tape', shortDescription: 'Corrosion-resistant PVC tape for protecting underground pipes and conduits.', category: 'specialty-tapes', features: ['Protects against corrosion and abrasion', 'Flexible and conformable', 'Moisture and chemical resistant'], uses: ['Wrapping metal pipes and conduits', 'Underground pipeline protection', 'Joint and fitting sealing'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/pvc%20pipe%20tape%20(1).webp'] },
    ...
    { id: 'acetate-cloth-tape-white-19mm-x-66m-crop', name: 'Acetate Cloth Tape', shortDescription: 'Conformable woven acetate cloth tape for electrical insulation and coil wrapping.', category: 'specialty-tapes', features: ['Excellent conformability', 'Good electrical insulation properties', 'Printable surface'], uses: ['Coil and transformer wrapping', 'Wire harnessing', 'Motor repairs'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/acetate-cloth-tape-white-19mm-x-66m-crop.webp'] },
    { id: 'stickymat', name: 'Sticky Mat', shortDescription: 'Multi-layered adhesive mats that capture dirt and contaminants from shoes before entering clean areas.', category: 'specialty-tapes', features: ['Tacky surface removes contaminants', 'Peel-off sheets for a fresh surface', 'Non-skid backing'], uses: ['Cleanroom entrances', 'Hospitals and labs', 'Construction sites'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/stickymat.webp'] },
    ...
    { id: 'green-polyster', name: 'Green Polyester Tape', shortDescription: 'High-temperature polyester tape for masking in powder coating, anodizing, and e-coating.', category: 'specialty-tapes', features: ['Withstands high temperatures (up to 204°C)', 'Removes cleanly without residue', 'Chemical resistant'], uses: ['Powder coating masking', 'Anodizing and plating', 'Splicing silicone-coated papers'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/green%20polyster.webp'] },
    { id: 'green-polyster-with-liner', name: 'Green Polyester Tape with Liner', shortDescription: 'High-temp green polyester tape with a release liner, ideal for die-cutting applications.', category: 'specialty-tapes', features: ['Release liner for easy die-cutting', 'Same high-temp performance', 'Precise masking shapes'], uses: ['Custom die-cut masking parts', 'Electronics masking', 'Aerospace applications'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/green%20polyster%20with%20liner.webp'] },
    { id: 'thermal-condu-pads', name: 'Thermal Conductive Pads', shortDescription: 'Soft, conformable pads that transfer heat between components and heat sinks.', category: 'specialty-tapes', features: ['High thermal conductivity', 'Gap-filling and vibration damping', 'Electrically isolating'], uses: ['Electronics cooling', 'LED lighting', 'Automotive electronics'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/thermal%20condu%20pads.webp'] },
    { id: 'surface-protection-tape', name: 'PE Surface Protection Film', shortDescription: 'Temporary film to protect surfaces from scratches, dirt, and damage during manufacturing and transit.', category: 'specialty-tapes', features: ['Removes cleanly without residue', 'Available in various tack levels', 'Protects against abrasion and contamination'], uses: ['Protecting metal, plastic, and glass surfaces', 'Appliance manufacturing', 'Automotive component protection'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/surface%20protection%20tape.webp'] },
    { id: 'green-powder-coating-tape-500x500-1', name: 'Powder Coated Tape', shortDescription: 'Specialized masking tapes designed to withstand the powder coating process.', category: 'specialty-tapes', features: ['High temperature resistance', 'Clean removal', 'Prevents paint ingress'], uses: ['Masking parts during powder coating', 'Masking threads and holes', 'High-temp finishing'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/green-powder-coating-tape-500x500%20(1).webp'] },
    ...
    { id: 'foil-scrim-kraft-tape', name: 'Aluminium Foil Scrim Kraft Tape (FSK)', shortDescription: 'A foil/scrim/kraft laminate tape for sealing insulation joints and seams in HVAC applications.', category: 'specialty-tapes', features: ['Tri-directional reinforcement', 'High tensile strength', 'Acts as a vapor barrier'], uses: ['Sealing foil-faced insulation', 'HVAC duct wrapping', 'Vapor sealing'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/foil-scrim-kraft-tape.webp'] },
    { id: 'aluminium-pet', name: 'Aluminium PET Tape (Alupet)', shortDescription: 'A laminate of aluminum foil and polyester film, providing high strength and reflectivity.', category: 'specialty-tapes', features: ['High tensile strength from PET layer', 'Heat and light reflective', 'Good for shielding'], uses: ['Cable shielding', 'Decorative applications', 'Heat shielding'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/aluminium%20pet.webp'] },
    { id: 'butyl', name: 'Aluminium Butyl Tape', shortDescription: 'A conformable foil tape with a thick butyl adhesive for instant, waterproof sealing.', category: 'specialty-tapes', features: ['Excellent waterproofing', 'Strong adhesion to most surfaces', 'UV resistant'], uses: ['Roof and gutter repairs', 'Sealing joints in construction', 'Automotive sound deadening'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/butyl.webp'] },
    { id: 'fiberglass-tape', name: 'Fiber Glass Cloth Tape', shortDescription: 'High-strength, high-temperature tape made from woven fiberglass cloth.', category: 'specialty-tapes', features: ['High tensile strength', 'Abrasion resistant', 'Withstands high temperatures'], uses: ['High-temperature duct sealing', 'Reinforcing and repairing', 'Electrical insulation'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/fiberglass%20tape.webp'] },
    ...
    { id: 'pink-rayon', name: 'Pink Rayon Tape', shortDescription: 'High-quality rayon tape for specific industrial applications requiring its unique properties.', category: 'specialty-tapes', features: ['High tensile strength', 'Low elongation', 'Printable surface'], uses: ['Coil wrapping and insulation', 'Banding and reinforcing', 'Printing industry applications'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/pink%20rayon.webp'] },
    { id: 'yellow-polyester', name: 'Yellow Polyester Tape', shortDescription: 'A high-visibility polyester tape for splicing, color-coding, and general industrial use.', category: 'specialty-tapes', features: ['Bright yellow color for visibility', 'Durable polyester backing', 'Good chemical resistance'], uses: ['Color-coding components', 'Splicing films', 'Decorative applications'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/yellow%20polyester.webp'] },
    { id: 'aluminium-fr-grade', name: 'Aluminium Glass Tape (FR Grade)', shortDescription: 'A laminate of aluminum foil and glass cloth, providing fire resistance and high strength.', category: 'specialty-tapes', features: ['Fire retardant (FR grade)', 'High temperature resistance', 'Excellent strength and durability'], uses: ['Aerospace applications', 'Marine and shipbuilding', 'High-temp insulation sealing'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/aluminium%20fr%20grade.webp'] },
    { id: 'red-pvc-non-adhesive-tape', name: 'PVC Pipe Wrapping Tape (Without Adhesive)', shortDescription: 'Non-adhesive PVC tape for wrapping and protecting pipes through tension.', category: 'specialty-tapes', features: ['Non-adhesive, self-clinging under tension', 'Corrosion protection', 'Flexible and easy to apply'], uses: ['Wrapping underground pipes', 'Protecting tool handles', 'Color-coding pipes'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/Red-PVC-Non-Adhesive-Tape.webp'] },
    ...
    { id: 'reinforced-paper-tapes1', name: 'Reinforcement Kraft Paper Tape', shortDescription: 'Kraft paper tape reinforced with fiberglass filaments for heavy-duty sealing.', category: 'specialty-tapes', features: ['Fiberglass reinforcement', 'High tensile strength', 'Water-activated or self-adhesive'], uses: ['Sealing heavy or over-stuffed cartons', 'Reinforcing boxes', 'High-security packaging'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/reinforced-paper-tapes1.webp'] },
    ...
    { id: 'cloth-adhesive-tape-500x500-1', name: 'Adhesive Cloth Tape', shortDescription: 'Versatile cloth tape with a strong adhesive for bookbinding, repairs, and color-coding.', category: 'specialty-tapes', features: ['Durable cloth backing', 'Available in multiple colors', 'Conformable and easy to tear'], uses: ['Bookbinding and spine repairs', 'Color-coding cables', 'General purpose repairs'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/cloth-adhesive-tape-500x500%20(1).webp'] },

    // --- Teflon & PTFE Tapes ---
    { id: 'ptfe-coated-fabric-non-adhesive-1', name: 'Non-Adhesive PTFE Coated Fiberglass Fabric', shortDescription: 'Non-stick, heat-resistant PTFE fabric for use as release sheets and conveyor belts.', category: 'teflon-ptfe-tapes', features: ['Excellent non-stick properties', 'High temperature and chemical resistance', 'Durable and flexible'], uses: ['Heat sealing machine release sheets', 'Conveyor belting', 'Composite mold release'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/ptfe%20coated%20fabric%20non%20adhesive%20(1).webp'] },
    { id: 'ptfe-silicone-adhesive', name: 'PTFE (Teflon) Coated Tape with Silicone Adhesive', shortDescription: 'PTFE coated fiberglass tape with a high-temperature silicone adhesive for non-stick applications.', category: 'teflon-ptfe-tapes', features: ['Non-stick PTFE surface', 'High-temperature silicone adhesive', 'Excellent chemical resistance'], uses: ['Heat sealer bar covering', 'Mold release liners', 'Chute and hopper linings'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/ptfe%20silicone%20adhesive.webp'] },
    { id: 'ptfe-fiberglass-with-silicone-adhesive', name: 'PTFE Coated Fiberglass Fabric with Silicone Adhesive', shortDescription: 'A premium grade PTFE tape offering superior performance and durability.', category: 'teflon-ptfe-tapes', features: ['Heavy-duty PTFE coating', 'High-performance silicone adhesive', 'Longer lifespan in demanding applications'], uses: ['High-speed packaging machines', 'Demanding release applications', 'Industrial conveyor systems'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/ptfe%20fiberglass%20with%20silicone%20adhesive.webp'] },

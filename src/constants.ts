...
export const PRODUCTS: Omit<Product, 'seo'>[] = [
    ...
    { id: 'paper-tape', name: 'Paper Tape', shortDescription: 'Eco-friendly paper tapes for packaging, crafting, and general use.', category: 'specialty-tapes', features: ['Kraft paper backing', 'Recyclable and biodegradable', 'Good adhesion'], uses: ['Picture framing', 'Packaging', 'Craft projects'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/masking%20tape.webp'] },
    ...
    { id: 'green-polyester-tape', name: 'Green Polyester Tape', shortDescription: 'High-temperature polyester tape for masking in powder coating, anodizing, and e-coating.', category: 'specialty-tapes', features: ['Withstands high temperatures (up to 204°C)', 'Removes cleanly without residue', 'Chemical resistant'], uses: ['Powder coating masking', 'Anodizing and plating', 'Splicing silicone-coated papers'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/green%20polyester.webp'] },
    { id: 'green-polyester-tape-with-liner', name: 'Green Polyester Tape with Liner', shortDescription: 'High-temp green polyester tape with a release liner, ideal for die-cutting applications.', category: 'specialty-tapes', features: ['Release liner for easy die-cutting', 'Same high-temp performance', 'Precise masking shapes'], uses: ['Custom die-cut masking parts', 'Electronics masking', 'Aerospace applications'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/green%20polyester%20with%20liner.webp'] },
    ...
    { id: 'pe-surface-protection-film', name: 'PE Surface Protection Film', shortDescription: 'Temporary film to protect surfaces from scratches, dirt, and damage during manufacturing and transit.', category: 'specialty-tapes', features: ['Removes cleanly without residue', 'Available in various tack levels', 'Protects against abrasion and contamination'], uses: ['Protecting metal, plastic, and glass surfaces', 'Appliance manufacturing', 'Automotive component protection'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/pe%20surface%20protection%20tape.webp'] },
    ...
    { id: 'nbr-foam-tapes', name: 'NBR Foam Tapes', shortDescription: 'Nitrile rubber foam tapes providing excellent sealing against air, dust, and moisture.', category: 'specialty-tapes', features: ['Good resistance to oils and chemicals', 'Flexible and conformable', 'Excellent sealing properties'], uses: ['Gasketing and sealing', 'Cushioning and vibration damping', 'Automotive applications'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/nbr%20foam%20tape.webp'] },
    ...
    // --- Teflon & PTFE Tapes ---
    { id: 'ptfe-coated-fiberglass-fabric-non-adhesive', name: 'Non-Adhesive PTFE Coated Fiberglass Fabric', shortDescription: 'Non-stick, heat-resistant PTFE fabric for use as release sheets and conveyor belts.', category: 'teflon-ptfe-tapes', features: ['Excellent non-stick properties', 'High temperature and chemical resistance', 'Durable and flexible'], uses: ['Heat sealing machine release sheets', 'Conveyor belting', 'Composite mold release'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/ptef%20coated%20fabric%20non%20adhesive%20(1).webp'] },
    { id: 'ptfe-silicone-adhesive-tape', name: 'PTFE (Teflon) Coated Tape with Silicone Adhesive', shortDescription: 'PTFE coated fiberglass tape with a high-temperature silicone adhesive for non-stick applications.', category: 'teflon-ptfe-tapes', features: ['Non-stick PTFE surface', 'High-temperature silicone adhesive', 'Excellent chemical resistance'], uses: ['Heat sealer bar covering', 'Mold release liners', 'Chute and hopper linings'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/ptef%20silicone%20adhe.webp'] },
    { id: 'ptfe-coated-fiberglass-fabric-with-silicone-adhesive', name: 'PTFE Coated Fiberglass Fabric with Silicone Adhesive', shortDescription: 'A premium grade PTFE tape offering superior performance and durability.', category: 'teflon-ptfe-tapes', features: ['Heavy-duty PTFE coating', 'High-performance silicone adhesive', 'Longer lifespan in demanding applications'], uses: ['High-speed packaging machines', 'Demanding release applications', 'Industrial conveyor systems'], images: ['https://file.garden/aIULwzQ_QkPKQcGw/ptef%20fiberglass%20with%20silicone%20adhesive.webp'] },

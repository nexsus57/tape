...
export const CATEGORIES: Category[] = [
    ...
    },
    {
        ...
        seo: {
            title: "Reflective Tapes & Fabrics Supplier | High-Visibility Tapes",
            description: "Buy high-visibility reflective tapes and fabrics from Tape India. We offer sew-on, heat transfer, and PVC reflective tapes for safety and apparel. B2B supplier.",
        }
    },
    {
    ...
    },
    {
        ...
        seo: {
            title: "PTFE & Teflon Tapes Manufacturer | High-Temp Non-Stick Tapes",
            description: "Buy high-temperature, non-stick PTFE & Teflon tapes from Tape India. Ideal for heat sealing, mold release, and low-friction applications. Supplier in India.",
        }
    },
    {
        ...
        description: 'Safeguard your sensitive components with our range of Antistatic and ESD tapes. We provide high-temperature polyimide (Kapton) tapes for masking, conductive tapes for shielding, and thermal management tapes for reliable performance in electronics assembly.',
        seo: {
            title: "Antistatic & ESD Tapes | Kapton & Conductive Tapes | Tape India",
            description: "Protect sensitive electronics with our ESD and antistatic tapes. We supply Kapton, conductive grid, and copper foil tapes for manufacturing. Get a quote.",
        }
    },
];
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    seo: {
      title: "Floor Marking Tape | Heavy-Duty PVC Aisle Tape | Tape India",
      description: "Organize your workspace with durable floor marking tape from Tape India. Our PVC tapes are ideal for aisle marking and safety zones. B2B supplier in Chennai."
    }
  },
  {
    id: 'anti-skid-tape',
    name: 'Anti-Skid Tape',
    category: 'safety-tpes',
    ...
    seo: {
      title: "Anti-Skid Tape Manufacturer | High-Traction Safety Tape",
      description: "Prevent slips and falls with Tape India's high-traction anti-skid tape. Ideal for stairs, ramps, and industrial floors. Buy direct from the manufacturer."
    }
  },
  {
    id: 'caution-tape',
  ...
  },
  {
    ...
    seo: {
      title: "BOPP Tape Manufacturer | Brown & Clear Packaging Tape",
      description: "Source high-quality BOPP tape for all your carton sealing needs. We manufacture clear, brown, and custom printed packaging tapes. B2B supplier in India."
    }
  },
  {
    ...
    seo: {
      title: "Aluminium Foil Tape | HVAC Sealing & Insulation Tape",
      description: "Buy high-quality aluminium foil tape from Tape India. Ideal for HVAC duct sealing, thermal insulation, and heat shielding. Performs in a wide range of temperatures."
    }
  },
  {
    id: 'kapton-tape',
    ...
    seo: {
      title: "Kapton Tape Supplier | High-Temperature Polyimide Tape",
      description: "Source genuine Kapton® tape from Tape India. This high-temperature polyimide tape is essential for wave soldering and electronics masking. Clean removal."
    }
  },
  {
    id: 'cloth-duct-tape',
  ...
  },
  {
    ...
    seo: {
      title: "Copper Foil Tape with Conductive Adhesive | Tape India",
      description: "Buy versatile copper foil tape with conductive adhesive. Ideal for EMI shielding, grounding, and circuit repair. Manufacturer direct from Tape India."
    }
  },
  {

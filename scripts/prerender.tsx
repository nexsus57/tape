import fs from 'fs';
// Force export to overwrite github version
...
for (let url of routes) {
    ...
    if (pathname === '/') {
        ...
        // Create full path but output as .html to prevent folder/trailing slash 404s
        const fullPath = path.resolve(_dirname, '../dist', pathname.substring(1) + '.html');
